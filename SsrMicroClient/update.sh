...
wget https://raw.githubusercontent.com/felixonmars/dnsmasq-china-list/master/google.china.china.conf -O google.china.conf
...
cat google.china.conf | sed 's/server=\///g' | sed 's/\/114\.114\.114\.114/ direct/g' >> SsrMicroClient.conf
