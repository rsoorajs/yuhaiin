...
cat accelerated-domains.china.conf | sed 's/server=\///g' | sed 's/\/114\.114\.114\.114/ ipDirect/g' > yuhaiin.conf
cat google.china.conf | sed 's/server=\///g' | sed 's/\/114\.114\.114\.114/ ipDirect/g' >> yuhaiin.conf
cat apple.china.conf | sed 's/server=\///g' | sed 's/\/114\.114\.114\.114/ ipDirect/g' >> yuhaiin.conf
